...
import type { Position, ScaledPosition, IHighlight, Scaled, LTWH, T_EventBus, T_PDFJS_Viewer, T_PDFJS_LinkService, T_PDFJS_FindController } from "../types";
...
interface Props<T_HT> {
    ...
    handleSingleHighlight: (singleList: any) => void;
}
export declare class PdfHighlighter<T_HT extends IHighlight> extends PureComponent<Props<T_HT>, State<T_HT>> {
    ...
    findController: T_PDFJS_FindController;
    ...
    setSearcher: (event: KeyboardEvent) => void;
    handleRecommendation: () => void;
    handleStop: () => void;
    handleSearch: () => void;
    SearchBack: () => void;
    handleSearchCurrent: () => void;
    handleSearchRedact: () => void;
    setMatchesCount: (matchesCount: any) => void;
    handlePrint: () => void;
    logText: () => void;
    render(): JSX.Element;
}
