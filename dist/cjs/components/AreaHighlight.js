...
class AreaHighlight extends react_1.Component {
    render() {
        const _a = this.props, { highlight, onChange, isScrolledTo, flag } = _a, otherProps = __rest(_a, ["highlight", "onChange", "isScrolledTo", "flag"]);
        return (react_1.default.createElement("div", { className: `AreaHighlight ${isScrolledTo ? "AreaHighlight--scrolledTo" : ""}` },
            react_1.default.createElement(react_rnd_1.Rnd, Object.assign({ className: flag ? "AreaRedact__part" : "AreaHighlight__part", onDragStop: (_, data) => {
